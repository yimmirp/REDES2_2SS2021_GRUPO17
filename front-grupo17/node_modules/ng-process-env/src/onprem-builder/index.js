...
exports.default = architect_1.createBuilder((options, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    additionalDataObjLit.getProperties()
        ...
        if (c.getType().isBoolean()) {
            const _var = ast_1.getBooleanFromProcess(propName);
            ...
            const _var = ast_1.getNumberFromProcess(propName);
            if (_var !== ast_1.NO_ENV_VAR_OR_VALUE_IN_PROCESS) {
                toUpdate = true;
                LOST_OF_VARS.push(_var);
            }
            ...
            const _var = ast_1.getStringFromProcess(propName);
            if (_var !== ast_1.NO_ENV_VAR_OR_VALUE_IN_PROCESS) {
                toUpdate = true;
                LOST_OF_VARS.push(_var);
            }
            ...
            const _var = ast_1.getAnyValueFromProcess(propName);
            if (_var !== ast_1.NO_ENV_VAR_OR_VALUE_IN_PROCESS) {
                toUpdate = true;
                LOST_OF_VARS.push(_var);
            }
